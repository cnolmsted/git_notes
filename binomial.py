...
How to use in python example: from binomial import choose
...
#the following stops program here if it is imported into python so you can simply use the above modules
...
#remember the following only works if --log is the third argument
    if arg3 == "--log":
        print("...and the log-base-10 of %d is: %f" % (choose(n,k),chooseLog10(n,k)))
    break